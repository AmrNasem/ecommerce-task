...
function Signup() {
  ...
  return <div className="flex items-center justify-center min-h-[calc(100dvh-62.4px)] bg-gray-50">
    <div className="w-full max-w-md">
      <div className="p-8 bg-white rounded-lg shadow-md border border-gray-300">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            />
            {
              errors.username && <p className="text-sm text-red-500 mt-1">
                {tAuth(`username.errMessage`)}
              </p>
            }
          </div>
          <div>
          ...
          <Button
            type="submit"
            disabled={isPending}
            className={`w-full px-4 py-2 text-white rounded-md focus:outline-none ${isPending
