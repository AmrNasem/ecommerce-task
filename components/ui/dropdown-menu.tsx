...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "z-50 min-w-36 overflow-hidden rounded-md border border-black/10 bg-background p-1 shadow-md",
        className
      )}
      {...props}
    />
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-48 overflow-hidden rounded-md border border-black/10 bg-background p-1 shadow-md",
          className
        )}
        {...props}
      />
