...
function CartNavigator() {
  ...
  return <Link href="/cart" className="hover:bg-[#e9ebef] p-1 rounded-md duration-150 cursor-pointer relative">
    <div className={cn("absolute rounded-full size-5 flex items-center justify-center bg-primary text-white bottom-full -translate-x-3 translate-y-3 text-[12px]", locale === "ar" ? "end-full" : "start-full")}>{cartBadge}</div>
